<x-leap::auth-card :status="session('leap.status')">
    <form wire:submit="submit" class="leap-form" novalidate>
        <fieldset class="leap-fieldset">
            ...
            <x-leap::input id="remember" type="checkbox" role="switch" name="remember" wire:model.live.blur="remember" label="{{ __('leap::auth.remember_me') }}" />
        </fieldset>
